...
## Current phase
Core v0.6 — Identity, Authentication, Organizations, DBA scopes, RBAC, immutable Audit Ledger, Security Events, tenant-safe API guards, HR Knowledge foundation and CRM v1.
