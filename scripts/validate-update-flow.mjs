...
const checks=[
 ...
 ['update core compares runtime SHA',update.includes('release_runtime_sha_mismatch')&&update.includes('fingerprint.sourceSha')],
 ...
 ['API fingerprint bypasses SW',sw.includes("url.pathname.startsWith('/api/')")],
