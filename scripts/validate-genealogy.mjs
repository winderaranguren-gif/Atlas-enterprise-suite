...
const requiredByBranch={
  ...
  '15-research-future-observatory-invention':['functional-reference-intake','capability-harvest-rebuild','research-question-registry','evidence-source-registry','experiment-protocol-registry','validation-ladder','novelty-prior-art-review','research-to-branch-promotion']
};
const invariantByBranch={
  ...
  '15-research-future-observatory-invention':['functional-reference-rebuild-does-not-copy-proprietary-code-content-assets','reference-study-and-atlas-implementation-are-distinct-states','research-does-not-silently-mutate-production']
};

assert.equal(files.length,15,'genealogy_requires_exactly_fifteen_structured_branches');
