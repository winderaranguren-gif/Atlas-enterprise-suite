...
if(/\b(?:runpod|heygen|magnific|descript|adobe)\b/i.test(files.gpu+'\n'+files.trainer))throw new Error('creative/provider dependency leaked into first-party GPU/STT foundation');
