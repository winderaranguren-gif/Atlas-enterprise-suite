...
const html=read('public/index.html'),app=read('public/app.js'),core=read('public/core-services.js'),music=read('public/music-core.js'),sw=read('public/sw.js'),headers=read('public/_headers'),wrangler=read('wrangler.toml'),redirects=read('public/_redirects');
