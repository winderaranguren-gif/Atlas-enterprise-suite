...
CREATE INDEX IF NOT EXISTS idx_finance_periods_scope_dates
  ON finance_accounting_periods(organization_id,dba_id,start_date,end_date,status);
...
CREATE INDEX IF NOT EXISTS idx_finance_tax_payments_scope
  ON finance_tax_payments(organization_id,dba_id,tax_item_id,payment_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_finance_asset_disposals_scope
  ON finance_asset_disposals(organization_id,dba_id,disposal_date DESC);
